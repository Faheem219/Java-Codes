...
public class Product {
    ...
    public void printProduct(){
        System.out.println(model+manufacturer+width+height+depth);
    }
}

// These are normal inheritance classes
...
class Motherboard extends Product {
    ...
    public void motherboardInfo(){
        System.out.println(ramSlots+cardSlots+bios);
    }
}
